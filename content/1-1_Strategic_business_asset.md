...
<figure>
  <img src="./assets/data-as-a-business-asset.png" alt= "Data becomes a business asset and creates value when it is trustworthy, well-documented, structured and versioned" ="width: 70%; max-width: 70%; margin: 0 auto; display: block;" />
